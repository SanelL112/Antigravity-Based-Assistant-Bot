...
MEGA_GUIDE_CLOUD_CLASSIFICATION = _value("MEGA_GUIDE_CLOUD_CLASSIFICATION", "PRIVATE").strip().upper()
...
LOG_SCAN_DIRS = [
    ...
    for directory in _value("LOG_SCAN_DIRS", str(LOG_DIR)).split(os.pathsep)
    if directory
]
...
OPENCODE_ZEN_MODEL = _value("OPENCODE_ZEN_MODEL", "mimo-v2.5-free")
OPENCODE_ZEN_FALLBACK_MODEL = _value("OPENCODE_ZEN_FALLBACK_MODEL", "mimo-v2.5-free")
CANVAS_VIRTUAL_DISPLAY = _value("CANVAS_VIRTUAL_DISPLAY", ":99")
CANVAS_REAUTH_COOLDOWN_SECONDS = _integer("CANVAS_REAUTH_COOLDOWN_SECONDS", 1800)
...
CHAT_HISTORY_RETENTION_DAYS = max(0, _integer("CHAT_HISTORY_RETENTION_DAYS", 30))
